const myModule = (() => {
  ...
  const btnPerimSquare = document.querySelector("#btnPerimSquare"),
        ...
        btnAeaTriangle = document.querySelector("#btnAeaTriangle"),
  ...
  btnPerimTriangle.addEventListener('click',()=>{
    ...
    const result = `El perimetro del triangulo es: ${perimTriangle(
      value1,
      value2,
      value3
    )}`;
  ...
  btnAeaTriangle.addEventListener('click',()=> {
    ...
    const result = `El perimetro del triangulo es: ${areaTriangle(
      value1,
      value2
    )}`;
    valueResult.innerText = result;
