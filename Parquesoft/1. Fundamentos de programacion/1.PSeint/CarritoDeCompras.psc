Proceso CarritoTecnologia
	...
	Repetir
		...
		Segun opcion Hacer
			...
			1:
				AgregarProducto(nombres, precios, contador)
			2:
				MostrarCarrito(nombres, precios, contador)
			3:
				EliminarProducto(nombres, precios, contador)
			4:
				CalcularTotal(precios, contador)
			5:
...
Funcion AgregarProducto(nombres Por Referencia, precios Por Referencia, contador Por Referencia)
...
Funcion MostrarCarrito(nombres, precios, contador)
...
Funcion EliminarProducto(nombres Por Referencia, precios Por Referencia, contador Por Referencia)
...
Funcion CalcularTotal(precios, contador)
